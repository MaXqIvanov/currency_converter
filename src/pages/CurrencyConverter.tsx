...
export const CurrencyConverter = () => {
  ...
  const { current_currency_value, loading_currency, error } = useAppSelector(
    ...
    <div className="currency_converter">
      <div className="currency_converter__wrapper">
        ...
        <input
          ...
          onChange={(e) => handlerCurrencyValue(e.target.value)}
          className="custom_input"
          placeholder="15 usd in eth"
        />
